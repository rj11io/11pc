...
export const blogPlatformDocs: Publication = {
  ...
  description:
    "Complete documentation for 11pc: writing posts, the content contract, extending the renderer, running the site.",
  created: "2026-07-01",
  isNSFW: false,
  isNew: false,
  isFeatured: false,
  ...
  posts: [
    ...
    },
    {
      ...
      excerpt:
        "Forking the public 11pc repository and making it yours: what to replace, what to configure, what to leave alone.",
      created: "2026-07-14",
      authorIds: ["rj11io", "11ai"],
      isNSFW: false,
      isNew: false,
